# AppEase
An Apple Watch application which detects, tracks and helps alleviate anxiety attacks in children and teenagers. It aids doctors and parents monitor children's health data and develop a plan for their treatment. Part of the NYU CS Information Technology Project supervised by Professor Franchitti, Professor Gilberti, and NYU Meyers Hospital.
...
7. Simulate P2P nodes
    1. In a new terminal, with the current working directoy set to btpeer_p2p_framework/project_impl, execute ``python model.py 2001 5 0.0.0.0:2002 ../../demo_data/model2``
    2. In a new terminal, with the current working directory set to btpeer_p2p_framework/project_impl, execute ``python model.py 2000 5 0.0.0.0:2001 ../../demo_data/model1``
