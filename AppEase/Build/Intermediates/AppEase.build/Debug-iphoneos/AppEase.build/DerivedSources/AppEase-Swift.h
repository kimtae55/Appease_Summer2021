...
#ifndef APPEASE_SWIFT_H
#define APPEASE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppEase",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7AppEase11AppDelegate")
...
SWIFT_CLASS("_TtC7AppEase13SceneDelegate")
...
SWIFT_CLASS("_TtC7AppEase24WatchConnectivityManager")
...
@interface WatchConnectivityManager (SWIFT_EXTENSION(AppEase))
