...
// Generated by Apple Swift version 5.5 (swiftlang-1300.0.27.6 clang-1300.0.27.2)
#ifndef APPEASE_WATCHKIT_EXTENSION_SWIFT_H
#define APPEASE_WATCHKIT_EXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppEase_WatchKit_Extension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC26AppEase_WatchKit_Extension22ComplicationController")
@interface ComplicationController : NSObject <CLKComplicationDataSource>
- (void)getComplicationDescriptorsWithHandler:(void (^ _Nonnull)(NSArray<CLKComplicationDescriptor *> * _Nonnull))handler;
- (void)handleSharedComplicationDescriptors:(NSArray<CLKComplicationDescriptor *> * _Nonnull)complicationDescriptors;
...
SWIFT_CLASS("_TtC26AppEase_WatchKit_Extension17ExtensionDelegate")
...
SWIFT_CLASS("_TtC26AppEase_WatchKit_Extension24WatchConnectivityManager")
...
@interface WatchConnectivityManager (SWIFT_EXTENSION(AppEase_WatchKit_Extension))
...
- (void)session:(WCSession * _Nonnull)session didReceiveFile:(WCSessionFile * _Nonnull)file;
@end

@class WCSessionUserInfoTransfer;

@interface WatchConnectivityManager (SWIFT_EXTENSION(AppEase_WatchKit_Extension))
- (void)session:(WCSession * _Nonnull)session didFinishUserInfoTransfer:(WCSessionUserInfoTransfer * _Nonnull)userInfoTransfer error:(NSError * _Nullable)error;
